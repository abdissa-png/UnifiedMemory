...
## 4. Graph: protocol vs ABC

**`GraphStoreBackend`** is a **Protocol**—implementations **need not** share a base class, which keeps Neo4j and NetworkX adapters independent.
